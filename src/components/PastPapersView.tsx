...
import { PAST_PAPERS, PROVINCES, BOARDS, SUBJECTS } from '../data/pastPapers';
...
export default function PastPapersView({ profile }: PastPapersViewProps) {
  ...
  const filteredPapers = useMemo(() => {
    return PAST_PAPERS.filter(paper => {
      ...
      return matchesSearch && matchesSubject && matchesBoard && matchesProvince && matchesYear;
    });
  }, [searchQuery, selectedSubject, selectedBoard, selectedProvince, selectedYear]);
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-500">Access official past papers from DBE, IEB, and SACAI for your FET Phase studies.</p>
            </div>
          </div>
            ...
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-xs font-bold text-indigo-600">{paper.year}</span>
                </div>
              </div>
